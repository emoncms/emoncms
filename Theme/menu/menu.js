var menu = {
    ...
    draw_l1: function () {
        ...
        for (var l1 in menu.obj) {
            ...
            // Prepare icon
            let icon = '<span class="svg-icon-'+item['icon']+'"></span>';
            // Title
        ...
        for (var z in keys) {
            ...
            if (item['divider']!=undefined && item['divider']) {
                ...
                if (item['icon']!=undefined) {
                    icon = '<span class="svg-icon-'+item['icon']+'"></span>';
                }
    ...
    min_l2: function () {
        ...
        if (!(menu.l2_visible && menu.l2_min)) {
            ...
            $(".menu-title-l2 span").hide();
            var ctrl = $("#menu-l2-controls");
            ctrl.html('<span class="svg-icon-expand"></span>');
    ...
    exp_l2: function () {
        ...
        if (!menu.l2_visible || menu.l2_min) {
            ...
            $(".menu-title-l2 span").show();
            var ctrl = $("#menu-l2-controls");
            ctrl.html('<span class="svg-icon-contract"></span>');
