...
if ($session['write']) { ?>
    <div id="footer_nav"
         class="nav <?php echo $expanded ? 'expanded' : '' ?>"<?php if (empty($bookmarks)) echo ' style="display:none"' ?>>
        <?php
        echo makeLink(array(
        ...
        <h4 class="sidebar-title d-flex justify-content-between align-items-center">
            ...
            <a id="edit_bookmarks" style="text-indent: 0" class="btn btn-inverse btn-link p-2" type="button"
               href="/emoncms/user/bookmarks" title="<?php echo dgettext('theme_messages', 'Edit'); ?>">
                <svg class="icon">
