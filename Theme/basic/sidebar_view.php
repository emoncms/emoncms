            ...
            if (is_menu_item($item)) {
                if ($third_level_open && is_current_group($second_level_menu)) {
                    ...
                    if ($route->controller === getPathController(getKeyValue('path', $item))) {
                        ...
                        if (empty($item['title'])) {
                            $item['title'] = stripslashes($item['text']);
                        }
...
if ($session['write']) { ?>
            <div id="footer_nav" class="nav <?php echo $expanded ? 'expanded':''?>"<?php if (empty($bookmarks)) {
                ...
                ?>
                    ...
                    foreach ($bookmarks as $item) {
                        ...
                        if (!empty($url_parts['fragment'])) {
                            $item['href'].= sprintf('#%s', $url_parts['fragment']);
                        }
