...
if(file_exists(dirname(__FILE__)."/settings.php"))
{
    ...
    if (!isset($config_file_version) || $config_file_version < 7) $error_out .= '<p>settings.php config file has new settings for this version. Copy default.settings.php to settings.php and modify the later.</p>';
