...
class Process_ProcessList
{
    ...
    public function process_list() {
        ...
        $list[] = array(dgettext("process_messages","EXIT"), ProcessArg::NONE, "error_found", 0, DataType::UNDEFINED, "Hidden", 'desc'=>"".dgettext("process_messages",'<p>This was automaticaly added when a loop error was discovered on the processList or execution took too many steps to process.  Review the usage of GOTOs or decrease the number of items and delete this entry to resume execution.</p>'), 'internalerror'=>true,'internalerror_reason'=>"HAS ERRORS",'internalerror_desc'=>'Processlist disabled due to errors found during execution.');
        $list[] = array(dgettext("Max value allowed"), ProcessArg::VALUE, "max_value_allowed", 0, DataType::UNDEFINED, "Limits", 'desc'=>"".dgettext("<p>If value is greater than <i>max value allowed</i> then the value passed to following process will be the <i>max value allowed</i></p>"),'requireredis'=>false,'nochange'=>false);
        $list[] = array(dgettext("Min value allowed"), ProcessArg::VALUE, "min_value_allowed", 0, DataType::UNDEFINED, "Limits", 'desc'=>"".dgettext("<p>If value is lower than <i>min value allowed</i> then the value passed to following process will be the <i>min value allowed</i></p>"),'requireredis'=>false,'nochange'=>false);
    ...
    public function core_process_list()
    {
        ...
        $list[2] = array(dgettext("process_messages","x"),ProcessArg::VALUE,"scale",0,DataType::UNDEFINED,dgettext("process_messages","Calibration"), 'desc'=>"".dgettext("process_messages",'<p>Multiplies current value by given constant. This can be useful for calibrating a particular variable on the web rather than by reprogramming hardware.</p>'));
        $list[3] = array(dgettext("process_messages","+"),ProcessArg::VALUE,"offset",0,DataType::UNDEFINED,dgettext("process_messages","Calibration"), 'desc'=>"".dgettext("process_messages",'<p>Offset current value by given value. This can again be useful for calibrating a particular variable on the web rather than by reprogramming hardware.</p>'));
        ...
        $list[5] = array(dgettext("process_messages","Power to kWh/d"),ProcessArg::FEEDID,"power_to_kwhd",1,DataType::DAILY,dgettext("process_messages","Power & Energy"),array(Engine::PHPTIMESERIES,Engine::MYSQL,Engine::MYSQLMEMORY), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>Convert a power value in Watts to a feed that contains an entry for the total energy used each day (kWh/d)</p>'));
        $list[6] = array(dgettext("process_messages","x input"),ProcessArg::INPUTID,"times_input",0,DataType::UNDEFINED,dgettext("process_messages","Input"), 'desc'=>"".dgettext("process_messages",'<p>Multiplies the current value with the last value from other input as selected from the input list.</p>'));
        ...
        $list[13] = array(dgettext("process_messages","Phaseshift"),ProcessArg::VALUE,"phaseshift",0,DataType::UNDEFINED,"Deleted", 'desc'=>"");
        $list[14] = array(dgettext("process_messages","Accumulator"),ProcessArg::FEEDID,"accumulator",1,DataType::REALTIME,dgettext("process_messages","Misc"),array(Engine::PHPFINA,Engine::PHPTIMESERIES,Engine::MYSQL,Engine::MYSQLMEMORY), 'desc'=>"".dgettext("process_messages",'<p>Output feed accumulates by input value</p>'));
        $list[15] = array(dgettext("process_messages","Rate of change"),ProcessArg::FEEDID,"ratechange",1,DataType::REALTIME,dgettext("process_messages","Misc"),array(Engine::PHPFIWA,Engine::PHPFINA,Engine::PHPTIMESERIES), 'requireredis'=>true, 'desc'=>"".dgettext("process_messages",'<p>Output feed is the difference between the current value and the last</p>'));
        ...
        $list[17] = array(dgettext("process_messages","Daily Average"),ProcessArg::FEEDID,"average",2,DataType::HISTOGRAM,"Deleted",array(Engine::PHPTIMESERIES), 'desc'=>"");

        // to be reintroduced in post-processing
        $list[18] = array(dgettext("process_messages","Heat flux"),ProcessArg::FEEDID,"heat_flux",1,DataType::REALTIME,"Deleted",array(Engine::PHPFIWA,Engine::PHPFINA,Engine::PHPTIMESERIES), 'desc'=>"");

        // need to remove - result can be achieved with allow_positive & power_to_kwhd
        $list[19] = array(dgettext("process_messages","Power gained to kWh/d"),ProcessArg::FEEDID,"power_acc_to_kwhd",1,DataType::DAILY,"Deleted",array(Engine::PHPTIMESERIES), 'desc'=>"");
        ...
        $list[21] = array(dgettext("process_messages","kWh to Power"),ProcessArg::FEEDID,"kwh_to_power",1,DataType::REALTIME,dgettext("process_messages","Power & Energy"),array(Engine::PHPFIWA,Engine::PHPFINA,Engine::PHPTIMESERIES), 'requireredis'=>true, 'desc'=>"".dgettext("process_messages",'<p>Convert accumulating kWh to instantaneous power</p>'));

        $list[22] = array(dgettext("process_messages","- input"),ProcessArg::INPUTID,"subtract_input",0,DataType::UNDEFINED,dgettext("process_messages","Input"), 'desc'=>"".dgettext("process_messages",'<p>Subtracts from the current value the last value from other input as selected from the input list.</p>'));
        $list[23] = array(dgettext("process_messages","kWh to kWh/d"),ProcessArg::FEEDID,"kwh_to_kwhd",2,DataType::DAILY,dgettext("process_messages","Power & Energy"),array(Engine::PHPTIMESERIES), 'requireredis'=>true, 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>Upsert kWh to a daily value.</p>'));
        $list[24] = array(dgettext("process_messages","Allow positive"),ProcessArg::NONE,"allowpositive",0,DataType::UNDEFINED,dgettext("process_messages","Limits"), 'desc'=>"".dgettext("process_messages",'<p>Negative values are zeroed for further processing by the next processor in the processing list.</p>'));
        $list[25] = array(dgettext("process_messages","Allow negative"),ProcessArg::NONE,"allownegative",0,DataType::UNDEFINED,dgettext("process_messages","Limits"), 'desc'=>"".dgettext("process_messages",'<p>Positive values are zeroed for further processing by the next processor in the processing list.</p>'));
        $list[26] = array(dgettext("process_messages","Signed to unsigned"),ProcessArg::NONE,"signed2unsigned",0,DataType::UNDEFINED,dgettext("process_messages","Misc"), 'desc'=>"".dgettext("process_messages",'<p>Convert a number that was interpreted as a 16 bit signed number to an unsigned number.</p>'));
        $list[27] = array(dgettext("process_messages","Max daily value"),ProcessArg::FEEDID,"max_value",1,DataType::DAILY,dgettext("process_messages","Misc"),array(Engine::PHPTIMESERIES,Engine::MYSQL,Engine::MYSQLMEMORY), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>Maximal daily value. Upserts on the selected daily feed the highest value reached each day.</p>'));
        $list[28] = array(dgettext("process_messages","Min daily value"),ProcessArg::FEEDID,"min_value",1,DataType::DAILY,dgettext("process_messages","Misc"),array(Engine::PHPTIMESERIES,Engine::MYSQL,Engine::MYSQLMEMORY), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>Minimal daily value. Upserts on the selected daily feed the lowest value reached each day.</p>'));

        $list[29] = array(dgettext("process_messages"," + feed"),ProcessArg::FEEDID,"add_feed",0,DataType::UNDEFINED,dgettext("process_messages","Feed"), 'desc'=>"".dgettext("process_messages",'<p>Adds the current value with the last value from a feed as selected from the feed list.</p>'));
        $list[30] = array(dgettext("process_messages"," - feed"),ProcessArg::FEEDID,"sub_feed",0,DataType::UNDEFINED,dgettext("process_messages","Feed"), 'desc'=>"".dgettext("process_messages",'<p>Subtracts from the current value the last value from a feed as selected from the feed list.</p>'));
        $list[31] = array(dgettext("process_messages"," * feed"),ProcessArg::FEEDID,"multiply_by_feed",0,DataType::UNDEFINED,dgettext("process_messages","Feed"), 'desc'=>"".dgettext("process_messages",'<p>Multiplies the current value with the last value from a feed as selected from the feed list.</p>'));
        $list[32] = array(dgettext("process_messages"," / feed"),ProcessArg::FEEDID,"divide_by_feed",0,DataType::UNDEFINED,dgettext("process_messages","Feed"), 'desc'=>"".dgettext("process_messages",'<p>Divides the current value by the last value from a feed as selected from the feed list.</p>'));
        $list[33] = array(dgettext("process_messages","Reset to ZERO"),ProcessArg::NONE,"reset2zero",0,DataType::UNDEFINED,dgettext("process_messages","Misc"), 'desc'=>"".dgettext("process_messages",'<p>The value "0" is passed back for further processing by the next processor in the processing list.</p>'));
        ...
        $list[35] = array(dgettext("process_messages","Publish to MQTT"),ProcessArg::TEXT,"publish_to_mqtt",1,DataType::UNDEFINED,dgettext("process_messages","Misc"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>Publishes value to MQTT topic e.g. \'home/power/kitchen\'</p>'));

        $list[36] = array(dgettext("process_messages","Reset to NULL"),ProcessArg::NONE,"reset2null",0,DataType::UNDEFINED,dgettext("process_messages","Misc"), 'desc'=>"".dgettext("process_messages",'<p>Value is set to NULL.</p><p>Useful for conditional process to work on.</p>'));
        $list[37] = array(dgettext("process_messages","Reset to Original"),ProcessArg::NONE,"reset2original",0,DataType::UNDEFINED,dgettext("process_messages","Misc"), 'desc'=>"".dgettext("process_messages",'<p>The value is set to the original value at the start of the process list.</p>'));

        $list[42] = array(dgettext("process_messages","If ZERO, skip next"),ProcessArg::NONE,"if_zero_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is ZERO, process execution will skip execution of next process in list.</p>'));
        $list[43] = array(dgettext("process_messages","If !ZERO, skip next"),ProcessArg::NONE,"if_not_zero_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is NOT ZERO, process execution will skip execution of next process in list.</p>'));
        $list[44] = array(dgettext("process_messages","If NULL, skip next"),ProcessArg::NONE,"if_null_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is NULL, process execution will skip execution of next process in list.</p>'));
        $list[45] = array(dgettext("process_messages","If !NULL, skip next"),ProcessArg::NONE,"if_not_null_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is NOT NULL, process execution will skip execution of next process in list.</p>'));

        $list[46] = array(dgettext("process_messages","If >, skip next"),ProcessArg::VALUE,"if_gt_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is greater than the specified value, process execution will skip execution of next process in list.</p>'));
        $list[47] = array(dgettext("process_messages","If >=, skip next"),ProcessArg::VALUE,"if_gt_equal_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is greater or equal to the specified value, process execution will skip execution of next process in list.</p>'));
        $list[48] = array(dgettext("process_messages","If <, skip next"),ProcessArg::VALUE,"if_lt_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is lower than the specified value, process execution will skip execution of next process in list.</p>'));
        $list[49] = array(dgettext("process_messages","If <=, skip next"),ProcessArg::VALUE,"if_lt_equal_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is lower or equal to the specified value, process execution will skip execution of next process in list.</p>'));
        $list[50] = array(dgettext("process_messages","If =, skip next"),ProcessArg::VALUE,"if_equal_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is equal to the specified value, process execution will skip execution of next process in list.</p>'));
        $list[51] = array(dgettext("process_messages","If !=, skip next"),ProcessArg::VALUE,"if_not_equal_skip",0,DataType::UNDEFINED,dgettext("process_messages","Conditional - User value"), 'nochange'=>true, 'desc'=>"".dgettext("process_messages",'<p>If value from last process is NOT equal to the specified value, process execution will skip execution of next process in list.</p>'));
        ...
        $list[55] = array(dgettext("process_messages"," + source feed"),ProcessArg::FEEDID,"add_source_feed",0,DataType::UNDEFINED,dgettext("process_messages","Virtual"), 'desc'=>"".dgettext("process_messages",'<p>Add the specified feed.</p>'));
        $list[56] = array(dgettext("process_messages"," - source feed"),ProcessArg::FEEDID,"sub_source_feed",0,DataType::UNDEFINED,dgettext("process_messages","Virtual"), 'desc'=>"".dgettext("process_messages",'<p>Subtract the specified feed.</p>'));
        $list[57] = array(dgettext("process_messages"," * source feed"),ProcessArg::FEEDID,"multiply_by_source_feed",0,DataType::UNDEFINED,dgettext("process_messages","Virtual"), 'desc'=>"".dgettext("process_messages",'<p>Multiply by specified feed.</p>'));
        $list[58] = array(dgettext("process_messages"," / source feed"),ProcessArg::FEEDID,"divide_by_source_feed",0,DataType::UNDEFINED,dgettext("process_messages","Virtual"), 'desc'=>"".dgettext("process_messages",'<p>Divide by specified feed. Returns NULL for zero values.</p>'));
        $list[59] = array(dgettext("process_messages","1/ source feed"),ProcessArg::FEEDID,"reciprocal_by_source_feed",0,DataType::UNDEFINED,dgettext("process_messages","Virtual"), 'desc'=>"".dgettext("process_messages",'<p>Return the reciprical of the specified feed. Returns NULL for zero values.</p>'));
        return $list;
    }
