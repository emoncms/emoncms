...
class PHPFiwa implements engine_methods
{
     ...
     *
     * @param $feedid The id of the feed to fetch from
     ...
     * @param $dp The number of data points to return (used by some engines)
     * @return array|bool
     * @deprecated CHAVEIRO: this method is deprecated
     */
