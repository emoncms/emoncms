...
class MysqlTimeSeries implements engine_methods
{
     ...
     * @param null $arg $value optional padding mode argument
     ...
     *
     * @param $id The id of the feed to fetch from
     * @param $start The unix timestamp in ms of the start of the data range
     * @param $end The unix timestamp in ms of the end of the data range
     * @param $mode The name of the interval. Possible values are: daily, weekly, monthly, annual
     * @param $timezone The time zone to which the intervals refer
     * @return array|bool
     * @throws Exception
     *
     */
    ...
    /**
     * Return datapoint for requested timestamp. If feed does not contain a datapoint for requested timestamp,
     * the value is calculated using linear interpolation.
     *
     * @param $id The id of the feed to fetch from
     * @param $time The unix timestamp in ms of the requested datapoint
     * @return array
     */
    ...
    /**
     * Return the averaged data over interval for the given timerange. The returned timestamp denotes the intervals
     * start time. Averaging is performed over all values from time to time+interval.
     *
     * @param $id - The id of the feed to fetch from
     * @param $start - The unix timestamp in ms of the start of the data range
     * @param $end - The unix timestamp in ms of the end of the data range
     * @param $interval - The number os seconds for each data point to return (used by some engines)
     * @return array
     */
