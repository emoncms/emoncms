...
<p><?php echo tr('Alternatively, use the encrypted input method to post data with higher security.'); ?><br>
...
<br>
<p><b><?php echo tr('Input actions'); ?></b></p>
<table class="table">
